...
INTRO_MESSAGE = """
Welcome to NeuronCLI: your integrated AI environment in the terminal !

This is the main prompt and info window where you can find various information about the agents and available commands.

Use the input area below to execute NeuronCLI commands or send messages to active agents.
...
IPYTHON_SHELL_INTRO = """
[b u]NeuronCLI Ipython Shell[/]

[b blue]Commands[/]:
    [b yellow]intro[/]: Print this message

[b blue]Global variables[/]:
    [b yellow]app[/]: NeuronCLI `Textual` app instance
