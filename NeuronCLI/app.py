...
from .agent.base import NeuronCLIAgent
...
from .tuilib.widgets.header import NeuronCLIHeader
...
class NeuronCLIApp(App[None]):
    """Textual TUI for NeuronCLI.
    ...
    TITLE = f"ﲵ⚡NeuronCLI v{_version()}"
    SCREENS = {
    ...
    @property
    def active_agent(self) -> NeuronCLIAgent | None:
    ...
    def compose(self) -> ComposeResult:
        ...
        yield NeuronCLIHeader(id="app-header")
    ...
    def _embed_ipython(self, *args, **kwargs) -> None:
        ...
        #           colors="neutral",
        #           loop_runner="asyncio",
        #           banner1 = "NeuronCLI IPython Shell\n",
        #           )
