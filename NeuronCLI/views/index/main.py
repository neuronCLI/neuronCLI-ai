...
class IndexList(VerticalScroll, NeuronCLIDomNodeMixin, can_focus=False):
...
class IndexInfo(Container, NeuronCLIDomNodeMixin):
...
class IndexScreen(Screen[t.Any], NeuronCLIDomNodeMixin):
